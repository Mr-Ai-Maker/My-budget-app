...
showAuthMessage("تعذر الاتصال بالخادم، تحقق من الإنترنت");
...
const current = localStorage.getItem("appLanguage") || "ar";

localStorage.setItem("appLanguage", current==="ar" ? "en" : "ar");
...
<div class="swipe-action swipe-edit">✏️ تعديل</div>

<div class="swipe-action swipe-delete">🗑️ حذف</div>
